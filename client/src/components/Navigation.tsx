        ...
        <div className="flex justify-between items-center h-16 lg:h-20">
          ...
          <Link href="/" className="flex items-center space-x-2 sm:space-x-3 cursor-pointer group">
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
              className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-br from-[#2d5a8c] to-[#5d8abc] flex items-center justify-center shadow-lg flex-shrink-0"
            >
              ...
              <Link
                ...
                className={`relative px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${
                  scrolled
                    ? location === item.href
                      ? "text-[#e91e8c]"
                      : "text-gray-600 hover:text-[#2d5a8c] hover:bg-gray-100/80"
                    : location === item.href
                      ? "text-[#ff4db2]"
