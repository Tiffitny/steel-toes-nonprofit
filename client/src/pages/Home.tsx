  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#fafbfd]">
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center overflow-hidden">
        {/* Animated background */}
        <div className="absolute inset-0 bg-gradient-to-br from-[#2d5a8c] via-[#3d6a9c] to-[#4d7aac]">
      ...
      <section className="relative -mt-1 z-20">
        <div className="max-w-5xl mx-auto px-4">
          ...
          >
            <div>
              <p className="text-3xl sm:text-4xl font-bold text-[#2d5a8c]" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
        ...
        <div className="max-w-7xl mx-auto">
          <AnimatedSection>
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl sm:text-5xl font-bold text-[#2d5a8c] tracking-tight" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
      ...
      <section className="w-full py-24 sm:py-32 px-4 sm:px-6 lg:px-8 bg-[#2d5a8c] relative overflow-hidden">
      ...
      <section className="w-full py-24 sm:py-32 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <AnimatedSection>
            ...
            <h2 className="text-4xl sm:text-5xl font-bold text-[#2d5a8c] tracking-tight mb-6" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/partnerships">
                <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
                  <Button size="lg" className="bg-gradient-to-r from-[#2d5a8c] to-[#5d8abc] hover:from-[#3d6a9c] hover:to-[#4d7aac] text-white rounded-full px-8 shadow-lg shadow-blue-900/20 w-full sm:w-auto">
