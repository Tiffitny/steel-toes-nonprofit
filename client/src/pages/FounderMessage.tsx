            ...
            <AnimatedSection className="lg:col-span-1">
              ...
              >
                ...
                <div className="mt-4 text-center">
                  <p className="font-bold text-[#2d5a8c] text-lg" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>Tiffany Johnson</p>
                ...
                <div className="bg-white rounded-2xl p-8 sm:p-10 shadow-sm border border-gray-100">
                  <div className="space-y-6">
                    ...
                    <motion.p
                      ...
                      className="text-[#2d5a8c] leading-relaxed text-xl font-bold pl-6 border-l-4 border-[#e91e8c]"
                    >
                    ...
                    <motion.p
                      ...
                      viewport={{ once: true }}
                      transition={{ duration: 0.5 }}
                      className="text-[#e91e8c] leading-relaxed text-2xl font-bold pl-6 border-l-4 border-[#2d5a8c]"
                    >
                      So I built one.
                    </motion.p>
                    ...
                    <motion.div
                      ...
                      className="bg-gradient-to-r from-[#2d5a8c] to-[#5d8abc] rounded-xl p-6 text-white"
                    >
