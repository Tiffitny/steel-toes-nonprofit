            ...
            {[
              ...
              <AnimatedSection key={i} delay={i * 0.1}>
                ...
                >
                  ...
                  <h3 className="font-bold text-[#2d5a8c] mb-1" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>{item.title}</h3>
                  {item.href ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
            ...
            <AnimatedSection className="lg:col-span-3">
              <div className="bg-white rounded-2xl p-8 sm:p-10 shadow-sm border border-gray-100">
                <h2 className="text-2xl font-bold text-[#2d5a8c] mb-2" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>Send a Message</h2>
            ...
            <AnimatedSection delay={0.2} className="lg:col-span-2">
              <div className="space-y-6">
                ...
                >
                  <h3 className="font-bold text-[#2d5a8c] mb-4" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>Quick Links</h3>
                ...
                <motion.div
                  whileHover={{ y: -2 }}
                  className="bg-gradient-to-br from-[#2d5a8c] to-[#5d8abc] rounded-2xl p-6 text-white"
                >
                ...
                <motion.div
                  ...
                  className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100"
                >
                  <h3 className="font-bold text-[#2d5a8c] mb-3" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>Prefer to call?</h3>
                  <p className="text-gray-600 text-sm mb-4">
                    Tiffany is available Monday through Friday, 9AM to 5PM. Don't be a stranger.
                  </p>
                  <a href="tel:+18632096615">
                    <Button variant="outline" className="w-full rounded-full border-[#2d5a8c]/20 text-[#2d5a8c] hover:bg-[#2d5a8c] hover:text-white">
