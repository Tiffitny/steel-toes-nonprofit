        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <AnimatedSection>
              ...
              >
                <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#2d5a8c] to-[#5d8abc] opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#2d5a8c] to-[#5d8abc] flex items-center justify-center mb-6 shadow-lg">
                  <Target className="h-7 w-7 text-white" />
                </div>
                <h3 className="text-2xl font-bold text-[#2d5a8c] mb-4" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>Our Mission</h3>
            ...
            <AnimatedSection delay={0.15}>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-[#2d5a8c] mb-4" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>Our Vision</h3>
                <p className="text-gray-600 leading-relaxed text-lg">
            ...
            {[
              ...
              <AnimatedSection key={i} delay={i * 0.15}>
                ...
                >
                  ...
                  <h3 className="text-xl font-bold text-[#2d5a8c] mb-3" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>{value.title}</h3>
